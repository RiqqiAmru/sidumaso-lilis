                                    ...
                                    <div class="col-md-4 mb-4">
                                        <div class="card shadow-sm">
                                            <div class="card-body">
                                                ...
                                                <?php if ($p['dokumen']): ?>
                                                    <a href="/uploads/pengumuman/<?= esc($p['dokumen']); ?>"
                                                        class="btn btn-link btn-sm">Download Dokumen</a>
                                                <?php else: ?>
                            ...
                            <div class="card info-card customers-card">
                                <div class="card-body text-center">
                                    <h5 class="card-title">
                                        ...
                                        <span
                                            style="font-size: 2em; font-weight: bold; color: blue;"><?= $jumlahProses; ?></span>
                                    </h5>
                                </div>
                            </div>
                        </a>
                            ...
                            <div class="card info-card customers-card">
                                <div class="card-body text-center">
                                    <h5 class="card-title">
                                        ...
                                        <span
                                            style="font-size: 2em; font-weight: bold; color: green;"><?= $jumlahSelesai; ?></span>
                                    </h5>
                                </div>
                            </div>
                        </a>
                            ...
                            <div class="card info-card customers-card">
                                <div class="card-body text-center">
                                    <h5 class="card-title">
                                        ...
                                        <span
                                            style="font-size: 2em; font-weight: bold; color: red;"><?= $jumlahInvalid; ?></span>
                                    </h5>
                                </div>
                            </div>
                        </a>
