            ...
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="<?= site_url('admin/manageuser/update/' . $user['id']); ?>" method="post">
                            <?= csrf_field(); ?>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <select class="form-control" id="role" name="role" required>
                                        ...
                                        <option value="Kepala_dusun" <?= $user['role'] == 'Kepala_dusun' ? 'selected' : ''; ?>>Kepala Dusun</option>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <select class="form-control" id="row_status" name="row_status" required>
                                        <option value="Menunggu" <?= $user['row_status'] == 'Menunggu' ? 'selected' : ''; ?>>Menunggu</option>
                                        <option value="Aktif" <?= $user['row_status'] == 'Aktif' ? 'selected' : ''; ?>>
                                            Aktif</option>
                                        <option value="Non-aktif" <?= $user['row_status'] == 'Non-aktif' ? 'selected' : ''; ?>>Non-aktif</option>
                                    </select>
                                </div>
                            </div>
